...
RedisPublisher.prototype._handleMetric = function _handleMetric(name, payload) {
  this.redisClient.publish(this.options.redis.prefix + name, JSON.stringify(payload));
}
